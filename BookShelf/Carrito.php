...
<body>
    <div id="Contenedor">
        ...
        <!-- CONTENIDO MAIN NUEVO -->
        <div id="Contenido">
            <div id="Carrito_Formato">
            ...
            <div id="Menu_carrito">
                ...
                <div id="Apartado_Pago">
                    <form action="php/pago_cheque.php" method="POST" id="iniciar">
                    <input  value=<?php echo $datosOrden['id_orden_pk'] ?> type="text" name="idOrd" autocomplete="off" class = "ocultos">
                        <button class="Boton_Pago" class="Formato_Botones">PAGO CHEQUE</button>
                    </form>
                    <form action="php/pago_tarjeta.php" method="POST" id="iniciar">
                        <input  value=<?php echo $datosOrden['id_orden_pk'] ?> type="text" name="idOrd" autocomplete="off" class = "ocultos">
